...
| V1.9.8.4          | 飞特全系列舵机/FT full series Servo | 兼容V1.9.8.2、增加HTS/HLS舵机支持/Compatible with v1.9.8.2, add support for HTS/HLS servos | 稳定版本/Stable version |
| FS-v2.2           | 飞特RCPWM舵机调试/FT RC servo debug | FS-v2.2 | 稳定版本/Stable version |
