FDUpdate.exe  
FD调试软件在线升级程序，使用FDUpdate可下载最新稳定版本FD软件  
FD debugging software online upgrade program, use fdupdate.exe to download the latest stable version of FD software

| fd版本/fd version | 舵机支持/Servo support              | 功能描述/description                                         | 状态                        |
| ----------------- | ----------------------------------- | ------------------------------------------------------------ | --------------------------- |
| V1.9.6            | SCS/SMS                             | FD1.9.6.7z/FD-v1.9.6(20200107)-EN-U.rar                      | 已停止维护/Stop maintenance |
